...
models = [ 
          ("llama3.2:3b","model_response.txt","invalid_lines.txt"),
...
You are a skilled medical doctor reviewing clinical text for factual or diagnostic errors.Each text may be correct or contain one error related to treatment, management, cause, or diagnosis.
